...
import 'package:emerance/widgets/actionButtonwithIcon.dart';
...
class _MapAmbulanceState extends State<MapAmbulance> {
 ...
 final List<LatLng> _latLang = <LatLng>[
  LatLng(1.494975, 103.743454),LatLng(1.492642, 103.741545),LatLng(1.491085, 103.752399),
  LatLng(1.502288, 103.749249),LatLng(1.461597, 103.762166),LatLng(1.488868, 103.770686),
  LatLng(1.493367, 103.767223),LatLng(1.484292, 103.775207),LatLng(1.485884, 103.759975),
  LatLng(1.471945, 103.736972),LatLng(1.476575, 103.749747),LatLng(1.477658, 103.724549),
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            children: [Image(image: AssetImage('assets/siren.png'),height: 45,width:45 ,),SizedBox(width: 20,),
                              Padding(
                                padding: const EdgeInsets.fromLTRB(0, 5, 0, 0),
                                child: Text('Ambulance '+i.toString(),style: TextStyle(
                                fontSize: 18,
