...
import '../widgets/actionButtonwithIcon.dart';
class MapMechanic extends StatefulWidget {
  const MapMechanic({Key? key}) : super(key: key);

  @override
  State<MapMechanic> createState() => _MapMechanicState();
}

class _MapMechanicState extends State<MapMechanic> {
  Completer<GoogleMapController> _controller = Completer();
  Uint8List? markerImage;
  List<String> images = [
    'assets/mechanic.png', 'assets/mechanic.png', 'assets/mechanic.png',
    'assets/mechanic.png', 'assets/mechanic.png', 'assets/mechanic.png',
    'assets/mechanic.png', 'assets/mechanic.png', 'assets/mechanic.png',
    'assets/mechanic.png', 'assets/mechanic.png', 'assets/mechanic.png',
    'assets/mechanic.png', 'assets/mechanic.png', 'assets/mechanic.png',
    'assets/mechanic.png', 'assets/mechanic.png',
  ...
  final List<LatLng> _latLang = <LatLng>[
    LatLng(1.496102, 103.743321),LatLng(1.492642, 103.741545),
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            children: [Image(image: AssetImage('assets/mechanic.png'),height: 45,width:45 ,),SizedBox(width: 20,),
                              Padding(
                                padding: const EdgeInsets.fromLTRB(0, 5, 0, 0),
                                child: Text('Mechanic '+i.toString(),style: TextStyle(
                                    fontSize: 18,
